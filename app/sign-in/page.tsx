    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="mx-auto w-full max-w-sm">
          ...
          <p className="text-muted-foreground mb-8">Sign in to access your arbitrage dashboard</p>
        ...
        <div className="max-w-md text-white text-center">
          ...
          <div className="mt-8 flex justify-center gap-8">
            <div>
              ...
              <p className="text-orange-100 text-sm">Odds feed</p>
            </div>
            <div>
              <p className="text-3xl font-bold">10+</p>
              <p className="text-orange-100 text-sm">Sportsbooks</p>
            </div>
            <div>
              <p className="text-3xl font-bold">2-way</p>
              <p className="text-orange-100 text-sm">Hedged edges</p>
            </div>
          </div>
        </div>
      </div>
